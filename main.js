...
let images = [
  ...
  {
    portrait_name: "Cat Commission",
    filename: "cat-commission-0.png",
    date: "2025-01-01",
  },
  {
    portrait_name: "Dog Commission",
    filename: "dog-commission-4.png",
    date: "2025-01-31",
  },
  {
    portrait_name: "Dog Commission",
    filename: "dog-commission-5.png",
    date: "2025-01-07",
  },
  {
    portrait_name: "Dog Commission",
    filename: "dog-commission-6.png",
    date: "2025-01-21",
  },
  {
    portrait_name: "Dog Squad",
    filename: "dog-commission-7.png",
    date: "2025-01-21",
  },
];
let mostRecent = [];
...
const sortedPortfolio = images.sort(
  (a, b) => new Date(b.date) - new Date(a.date)
);

const MOST_RECENT_COUNT = 8;
...
const createGridItemForImage = (image) => {
  ...
  description.innerText = `${image.portrait_name}, ${new Date(
    image.date
