...
function who_am_i() {
  $("#init_right_triangle").slideToggle("slow", function () {
        $(".me_foreground").slideToggle("slow",function(){
          $("#about").slideToggle("slow");
        });
    });
  $(".who_am_i_button").toggleClass('whoami1 whoami2');
  if ($(".who_am_i_button").hasClass('whoami1')){
    $(".who_am_i_button").html("Who am I?");
  }
  else{
    $(".who_am_i_button").html("Hide");
  }
