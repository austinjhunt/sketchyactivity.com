...
class PortfolioItem(models.Model):
    ...
    s3_copied_smaller_drawing_private_url = models.URLField(
    ...
    def format_json(self):
        return {
            ...
            'date': self.date,
            's3_drawing_private_url': self.s3_drawing_private_url,
            's3_copied_smaller_drawing_private_url': self.s3_copied_smaller_drawing_private_url
        }
...
class MetaStuff(models.Model):
    ...
    promo_message_html = models.TextField(default='')
...
class Purchase(models.Model):
    ...
    # save as now when purchase created
    timestamp = models.DateTimeField(auto_created=True)
    # indicate whether this was used for testing
...
class Price(models.Model):
    ...
    def format_json(self):
        return {
            ...
            'style': {'TR': 'traditional', 'DI': 'digital'}[self.style]
        }
