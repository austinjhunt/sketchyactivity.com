...
let showAddToCartModal = (data) => {
  ...
  if (data["type"] == "digital") {
    ...
    form.querySelector("input#size").disabled = true;
    form.querySelector("input#size").required = false;
  } else {
    form.querySelector("input#size").disabled = false;
    form.querySelector("input#size").required = true;
